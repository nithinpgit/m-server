...
<html>
    ...
    <body>
			...
			<div style="background:#367fa9;height:45px;"><br>
				<a class="btn btn-default pull-right" href="endconference.php?id=<?php echo $_GET['room']; ?>&lid=<?php echo $_GET['lid']; ?>" style="margin-top:-15px;margin-right:45px;">Leave Presentation</a>
			</div>
